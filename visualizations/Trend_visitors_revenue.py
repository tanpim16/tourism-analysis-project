...
def create_chart(cfg):
    ...
    handles = [
        ...
        plt.Line2D([0], [0], color='#888', linewidth=2, linestyle='-', alpha=0.8, label='Monthly actual'),
        plt.Line2D([0], [0], color='#888', linewidth=4, alpha=0.2, solid_capstyle='round', label='Trend (3-mo MA)'),
    ]
